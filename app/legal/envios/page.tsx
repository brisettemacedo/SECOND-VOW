...
export default function ShippingPolicy() {
  return <main className="legal-page">
    ...
    <p>Antes de registrar la guía, la vendedora debe conservar evidencia del estado del vestido, del paquete cerrado y del comprobante de recepción de la paquetería. No necesita cargarla en ese momento; SECOND VOW podrá solicitarla si existe una controversia. También se recomienda grabar video continuo del vestido y su empaquetado. Debe conservar los originales hasta que concluya la operación.</p>
    <h2>Envío de regreso</h2>
    <p>Cuando una decisión motivada autorice la devolución por un incumplimiento atribuible a la vendedora, ésta deberá contratar, pagar y compartir una guía prepagada. La compradora utilizará esa guía y confirmará la entrega del paquete a la paquetería. En los demás supuestos, la resolución indicará quién asume el retorno.</p>
    ...
    <h2>Daño o pérdida en tránsito</h2>
    <p>Si la evidencia apunta a pérdida o daño atribuible exclusivamente a la paquetería, deberá activarse primero el seguro contratado por la vendedora y conservarse el saldo mientras se documenta su respuesta. Haber contratado seguro, rastreo, firma y entrega contra identificación ayuda a determinar responsabilidad, pero no elimina derechos irrenunciables ni sustituye la revisión del embalaje y del estado declarado.</p>
