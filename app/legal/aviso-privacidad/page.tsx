...
export default function Privacy() {
  return <main className="legal-page">
    ...
    <p>Podemos tratar nombre, correo, teléfono y datos de cuenta; perfil y reputación; publicaciones, fotografías, medidas y descripciones; mensajes, ofertas y favoritos; nombre de la persona receptora, domicilio o sucursal de entrega; pedidos, pagos, comisiones, retiros, facturación, reclamaciones y evidencia; datos de soporte; dirección IP, dispositivo, navegador, registros de acceso, cookies y señales de prevención de fraude.</p>
    ...
    <p>La identificación oficial mostrada al momento de recibir se valida por la paquetería. SECOND VOW no solicita ni conserva una copia de esa identificación; podrá conservar únicamente la referencia de entrega, nombre reportado de quien recibió, firma o constancia que proporcione el transportista.</p>

    <h2>2. Finalidades primarias</h2>
    <p>Crear y administrar cuentas; autenticar usuarias; publicar y moderar vestidos; operar mensajes, ofertas, pedidos, pagos, envíos, saldos y retiros; mostrar reputación limitada; prevenir fraude, falsificación, abuso y evasión de comisiones; atender soporte, reclamaciones, devoluciones y derechos ARCO; conservar evidencia; proteger derechos; cumplir obligaciones contractuales, fiscales, contables y requerimientos de autoridad.</p><p>Con autorización opcional y separada, podremos usar fotografías de una publicación en redes sociales y campañas publicitarias de SECOND VOW. Negarte no impide publicar ni vender. Puedes retirar la autorización para usos futuros mediante nuestros canales de contacto.</p>
    ...
    <p>Podremos comunicar datos a compradora, vendedora y proveedores cuando sea necesario para ejecutar la operación solicitada; cumplir obligaciones legales; atender autoridades; prevenir fraude; o ejercer y defender derechos. El destino y nombre de recepción se comparten únicamente con la vendedora correspondiente después de que la compradora decide proporcionarlos para recibir una oferta y ejecutar la venta. Cuando una transferencia requiera consentimiento, se solicitará conforme a la ley.</p>
