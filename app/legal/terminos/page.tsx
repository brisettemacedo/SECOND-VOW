...
export default function Terms() {
  return <main className="legal-page">
    ...
    <h2>5. Ofertas, pedido y disponibilidad</h2>
    <p>La compradora puede conversar y preguntar por el precio, pero solo la vendedora emite la oferta formal. La oferta incluye el precio definitivo del vestido y un costo de envío fijo calculado con el código postal de la compradora. No hay contraofertas. La compradora puede aceptarla o rechazarla; la vendedora puede cancelarla mientras siga pendiente.</p>
    <p>La oferta vence en 48 horas. Al aceptarla se genera un pedido con hasta 48 horas para pagar. Puede reintentar Stripe dentro de ese plazo; cada sesión de Checkout dura aproximadamente 60 minutos. Ni aceptar ni abrir Checkout oculta la publicación. La primera compradora cuyo pago sea confirmado obtiene el vestido; los demás pedidos se cancelan y cualquier segundo cargo excepcional se revisa y reembolsa.</p>

    <h2>6. Precio y comisión</h2>
    <p>Publicar es gratuito. En una venta concluida, SECOND VOW retiene <strong>18% del total de la oferta: vestido más envío</strong>. Esa comisión contempla el costo ordinario de Stripe; no se agrega otro cargo administrativo fijo. La vendedora recibe el 82% del total y de ese saldo paga la guía.</p>
    ...
    <h2>8. Envío</h2>
    <p>SECOND VOW no ofrece pruebas ni entregas presenciales. La vendedora contrata una paquetería reconocida con rastreo, registra empresa y guía dentro de cinco días naturales desde el pago y embala adecuadamente el vestido. Seguro y firma son obligatorios desde $10,000 MXN y recomendables debajo de ese importe. Si el pago está en revisión, no debe enviar.</p>
    <h2>8.1 Fotografías y promoción</h2><p>La vendedora concede la licencia necesaria para mostrar las fotografías en la publicación y operar el marketplace. El uso adicional en redes sociales o publicidad requiere una autorización opcional y separada al publicar; puede retirarse para usos futuros, sin afectar materiales difundidos lícitamente ni evidencia que deba conservarse.</p>
