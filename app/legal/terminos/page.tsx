...
export default function Terms() {
  return <main className="legal-page">
    ...
    <p>Si la vendedora no registra una guía dentro de cinco días naturales, el sistema bloquea el envío tardío, coloca la operación en reembolso pendiente y mantiene el saldo bloqueado hasta que Stripe confirme el reembolso. Si la compradora desconoce el cargo, SECOND VOW bloquea envío y retiro y avisa a la vendedora. La aceptación automática de 48 horas no impide un contracargo bancario posterior; las partes deben conservar evidencia y cumplir cualquier devolución procedente.</p>
