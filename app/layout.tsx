...
export const metadata: Metadata = {
  ...
  description: "Marketplace remoto de vestidos de novia de segunda mano en México.",
};

export default function RootLayout({ children }:{ children:React.ReactNode }) {
  return <html lang="es-MX" className={`${spectral.variable} ${archivo.variable}`}><body><SiteHeader />{children}</body></html>;
}
